          ...
          <Card className="bg-white/95 backdrop-blur-sm shadow-xl rounded-2xl overflow-hidden border-none">
            <CardContent className="p-8 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 mb-6">
                Seu pagamento está sendo processado. Você receberá uma notificação quando for concluído.
              </p>

              <div className="flex flex-col sm:flex-row gap-3 w-full">
                <Button className="flex-1 bg-indigo-600 hover:bg-indigo-700" onClick={() => router.push("/home")}>
